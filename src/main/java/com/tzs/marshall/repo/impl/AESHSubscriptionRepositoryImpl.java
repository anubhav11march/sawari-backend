...
public class AESHSubscriptionRepositoryImpl implements AESHSubscriptionRepository {
    ...
    public List<AESHServicePlan> fetchAllServicePlansDetails() {
        try {
            String query = "SELECT plan_id, name, description, price, currency, validity FROM marshall_service.service_plans";
    ...
    public int updatePaymentStatus(TransactionDetail transactionDetail) {
        try {
            ...
            String query = "UPDATE marshall_service.transaction_details SET payment_status=:paymentStatus WHERE billing_id=:billingId";
    ...
    public List<TransactionDetail> getTransactionDetailsById(long id) {
        try {
            String query = "SELECT * FROM marshall_service.transaction_details WHERE billing_id=:id OR user_billing_id=:id OR order_id=:id OR transaction_id=:id";
    ...
    public int updateOrderStatus(OrderDetails order) {
        try {
            String query = "UPDATE marshall_service.order_details SET status=:status, warning_date=:warningDate, expiry_date=:expiryDate, modify_date=:modifyDate, is_paid=:isPaid" +
    ...
    public int updateOrder(OrderDetails orderDetails) {
        try {
            String query = "UPDATE marshall_service.order_details SET selected_services=:selectedServices, estimated_amount=:estimatedAmount, " +
    ...
    public String fetchQrCodeByName(String qrCodeType) {
        try {
            String query = "SELECT value FROM marshall_service.properties WHERE name=:qrCodeType";
