package com.tzs.marshall.author.filesystem;
...
public class FileServiceImpl implements FileService {
    ...
    public FileBean uploadFileHandler(FileBean fileBean) {
        ...
        fileBean = fileHelper.uploadFileHelper(fileBean);
        try {
    ...
    @Override
    public List<FileBean> fetchAllFiles() {
        log.info("Fetching All Files for All Authors...");
        List<FileBean> allAuthorsFiles = fileRepository.getAllAuthorsFiles();
    ...
    @Override
    public FileBean findAuthorFileById(long authorId, long fileId) {
        log.info(String.format("Fetching [AuthorId: %s, FileId: %s", authorId, fileId));
        List<FileBean> authorFileById = fileRepository.findAuthorFileById(authorId, fileId);
