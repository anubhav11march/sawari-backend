...
@RestController
@RequestMapping(value = {"/user", "/admin", "/driver"})
public class PaymentRestController {
    ...
    public OrderDetails createCheckout(@RequestBody OrderDetails orderDetails,
        ...
        try {
            ...
            order = subscriptionService.createOrderDetailsHandler(orderDetails, authorDetails);
    ...
    public ModelAndView checkoutOrder(@RequestParam("screenshot") MultipartFile file,
        ...
        try {
            ...
            transactionDetail = subscriptionService.transactionDetailsHandler(transactionDetail, authorDetails);
    ...
    public ModelAndView updateOrderPayment(@ModelAttribute TransactionDetail transactionDetail, @AuthenticationPrincipal PersistentUserDetails authorDetails,
        ...
        try {
            transactionDetail = subscriptionService.updatePaymentStatusHandler(transactionDetail);
