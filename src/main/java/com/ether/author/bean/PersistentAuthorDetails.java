...
@ToString
public class PersistentAuthorDetails implements UserDetails {
    ...
    public PersistentAuthorDetails() {
    }

    public PersistentAuthorDetails(Long userId, String email, String userName, String mobile) {
        this.userId = userId;
        this.email = email;
