...
import com.ether.author.bean.OrderDetails;
import com.ether.author.bean.PersistentAuthorDetails;
import com.ether.author.bean.TransactionDetail;
...
@RestController
@RequestMapping(value = {"/author", "/admin"})
public class PaymentRestController {
    ...
    */
    ...
    public ModelAndView checkoutOrder(@RequestParam("screenshot") MultipartFile file,
                                      @ModelAttribute TransactionDetail transactionDetail, @AuthenticationPrincipal PersistentAuthorDetails authorDetails,
                                      HttpSession session) {
        if (Constants.ADMINS.contains(authorDetails.getRoleName()))
    ...
    public ModelAndView updateOrderPayment(@ModelAttribute TransactionDetail transactionDetail, @AuthenticationPrincipal PersistentAuthorDetails authorDetails,
                                           HttpSession session) {
        if (Constants.ROLE_AUTHOR.equals(authorDetails.getRoleName()))
    ...
    public List<OrderDetails> getPaidOrders(@AuthenticationPrincipal PersistentAuthorDetails authorDetails) {
    ...
    public ModelAndView uploadQRCode(@RequestParam("name") String qrCodeName, @RequestParam("qrCode") MultipartFile qrCode,
                                     @AuthenticationPrincipal PersistentAuthorDetails authorDetails, HttpSession session) {
        if (Constants.ROLE_AUTHOR.equals(authorDetails.getRoleName()))
