<footer class="footer-base" th:fragment="frfooter">
  <div class="content">
    <!--<div class="container">
      <div class="row">
        &lt;!&ndash;<div class="col-md-4 footer-center text-left">
        ...
        <div class="col-md-4 footer-left text-left">
          <div class="row">
            <div class="col-md-6 text-s">
              ...
              &lt;!&ndash;                            <a href="#">Latest news</a><br />&ndash;&gt;

            </div>
            &lt;!&ndash;<div class="col-md-6 text-s">
              <h3>Pages</h3>
              <a href="#">Support</a><br />
        ...
        &lt;!&ndash;<div class="col-md-4 footer-left text-left">
    ...
    <div class="row copy-row">
      <div class="col-md-12 copy-text">
        © 2022 AESH | Developed by <a href="http://schiocco.io/">Zafar</a>
      </div>
    </div>
  </div>
