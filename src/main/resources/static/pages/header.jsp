<header class="fixed-top scroll-change" data-menu-anima="fade-in" th:fragment="frheader">
    <div class="navbar navbar-default mega-menu-fullwidth navbar-fixed-top" role="navigation">
        <div class="navbar-mini scroll-hide">
            <!-- <div class="container">
                 <div class="nav navbar-nav navbar-left">
 &lt;!&ndash;                    <span><i class="fa fa-phone"></i>1-800-405-377</span>&ndash;&gt;
 &lt;!&ndash;                    <hr />&ndash;&gt;
                     <span><i class="fa fa-envelope"></i>info@aesh.com</span>
                     <hr />
 &lt;!&ndash;                    <span>  <i class="fa fa-map-marker"></i>Collins Street 8007, USA</span>&ndash;&gt;
 &lt;!&ndash;                    <hr />&ndash;&gt;
 &lt;!&ndash;                    <span><i class="fa fa-calendar"></i>Mon - Sat: 8.00 - 19:00</span>&ndash;&gt;
                 </div>
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li class="dropdown active">
                            <a href="/index.html" class="dropdown-toggle" data-toggle="dropdown" role="button">Home
                            ...
                            <div class="mega-menu dropdown-menu multi-level row bg-menu">
                                <div class="col">
                                    <ul class="fa-ul no-icons text-s">
                                        <li><a href="/pages/english-language-editing.html">English Language Editing</a></li>
                                        <li><a href="about-us-2.html">Academic Translation</a></li>
                                        <li><a href="about-us-3.html">Academic Illustration</a></li>
                                        <li><a href="/pages/figure-formatting.html">Figure Formatting</a></li>
                                        <!--                                            <li><a href="pricing.html">Pricing</a></li>-->
                                    </ul>
                                </div>
                                <div class="col">
                                    <ul class="fa-ul no-icons text-s">
                                        <li><a href="certifications.html">Graphics Abstract Services</a></li>
                                        <li><a href="faq.html">Journal Recommendation</a></li>
                                        <li><a href="history.html">Conference Poster Creation</a></li>
                                        <li><a href="team.html">Research News Stories</a></li>
                        ...
                        <li class="dropdown">
                            <a href="/pages/aboutus.html" class="dropdown-toggle" data-toggle="dropdown" role="button">About Us
                                <!--                                    <span class="caret"></span>-->
                            </a>
                            <!--<ul class="dropdown-menu multi-level">
                        ...
                        <li class="dropdown">
                            <a href="/pages/contactus.html" class="dropdown-toggle" data-toggle="dropdown" role="button">Contact Us
                                <!--                                    <span class="caret"></span>-->
                            </a>
                            <!-- <ul class="dropdown-menu multi-level">
                    ...
                    <div class="nav navbar-nav navbar-right">
                        ...
                        <select id="lan" onchange="myLanguage()">
                            <a href="/index.html?locale=en"><option value="en">EN</option></a>
                            <a href="/index.html?locale=ar"><option value="ar">AR</option></a>
                        </select>
...
<!--                                <span class="caret"></span>-->
                                 <ul class="dropdown-menu">
                                     <li><a href="#"><img src="../images/it.png" alt="" />AR</a></li>
                                 </ul>
                            </li>
                        </ul>
                        <div class="search-box-menu">
                            ...
                            <br>
                            <a href="/login" style=" background-color: #755C9B; color: #fff" class="btn"  role="button">Login/Signup</a>
                        </div>
