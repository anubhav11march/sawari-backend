...
INSERT INTO `confirmation_token` VALUES (5,'d4dc6cf9-5397-40b6-984f-c86e85ebb68c','enableAccount','zaif99@gmail.com','2021-12-28 19:31:25','2021-12-28 19:46:25','2021-12-28 19:32:39'),(17,'4539d224-f6b6-4d9c-8979-48c314295c4f','resetPassword','zaif99@gmail.com','2022-02-15 06:45:47','2022-02-15 07:00:47',NULL),(24,'67e12cb4-d129-4478-bab9-c5438e470bf3','enableAccount','zafaralways@gmail.com','2021-12-28 19:21:23','2021-12-28 19:36:23','2021-12-28 19:22:01'),(25,'05e2e669-47c3-42bb-a964-919044940897','resetPassword','zafaralways@gmail.com','2021-12-28 19:24:15','2021-12-28 19:39:15','2021-12-28 19:24:50'),(26,'81752d2d-6b47-45ad-8b21-91797f4e49e7','enableAccount','thedarkthrister@gmail.com','2022-02-11 20:41:50','2022-02-11 20:56:50',NULL);
...
INSERT INTO `order_details` VALUES (35,97,19,83,3,'Scientific Editing',1000,'USD','2022-02-03 04:32:14','2022-02-18 04:32:14','2022-02-13 04:32:14','2022-02-03 04:34:22','test3','PLACED',1,0),(40,97,20,83,4,'Only English Editing,Journal Recommendation',250,'USD','2022-02-08 18:57:04','2022-03-11 19:14:44','2022-03-06 19:14:44','2022-02-09 19:14:44','payment test','PAID',1,1),(44,97,21,83,5,'Journal Recommendation',50,'USD','2022-02-12 22:02:45','2022-03-14 22:27:46','2022-03-09 22:27:46','2022-02-14 13:54:58','','PLACED',1,0);
...
INSERT INTO `transaction_details` VALUES (3,97,40,'1234',50,'USD','abc','UPI','13/02/2022','2022-02-12 22:07:37','PLACED'),(11,97,44,'123456',50,'USD','\\var\\aesh\\contents\\author\\97\\.png\\MicrosoftTeams-image (2).png','UPI','2022-02-13','2022-02-12 22:27:46','PLACED');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`system`@`localhost`*/ /*!50003 TRIGGER `user_registration_AFTER_INSERT` AFTER INSERT ON `user_registration` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`system`@`localhost` PROCEDURE `spInsertOrUpdateOrderDetails`(
    IN authorId int,
    IN fileId int,
    IN adminId int,
    IN reportId int,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`system`@`localhost` PROCEDURE `spInsertOrUpdateTransactionDetails`(
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`system`@`localhost` PROCEDURE `spInsertOrUpdateUserDetails`(
    IN userId int,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`system`@`localhost` PROCEDURE `spUpdateUserDetails`(
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`system`@`localhost` PROCEDURE `spUpdateUserRights`(
    IN userId int,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`system`@`localhost` PROCEDURE `spUserLogin`(
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`system`@`localhost` PROCEDURE `spUserMapping`(
    IN userId int
)
BEGIN
    Declare userAddressId int;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`system`@`localhost` PROCEDURE `spUserRoleTypeBridge`(
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
    /*!50013 DEFINER=`system`@`localhost` SQL SECURITY DEFINER */
...
-- Dump completed on 2022-02-17 13:50:26
